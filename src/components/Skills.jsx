...
const Skills = () => {
  return (
    <div className='skillsContainer' id='skills'>
      ...
      <p className='projectHeaderInfo' style={{paddingLeft: '2rem', paddingRight: '2rem'}}>Through 2+ years of programming, I can say that I have the following technical skills in understanding these frameworks and programming languages.</p>
      ...
      <hr />
      <h1>Soft Skills</h1>
      <p className='projectHeaderInfo' style={{paddingLeft: '2rem', paddingRight: '2rem'}}>Also in these 2+ years of programming, I have acquired the following soft skills by working alongside other programmers.</p>
      <div className="flex-container">
