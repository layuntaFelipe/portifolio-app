  ...
  return (
    <div className='heroContainer' id='hero'>
      ...
      <div className="heroInfo">
        ...
        <p>A passionate Full Stack Developer with more than 3 years of programming experience (Mobile Development + Web Development). As a Full Stack Web Developer, I bring to the table experience of building a real-world application using ReactJS, Javascript, NodeJS, Express, Firebase, MongoDB, and other cool and fun libraries that makes our lives better and easier.</p>
